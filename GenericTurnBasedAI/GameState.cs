...
{
	/// <summary>
	/// The super-class for GameStates. Represents the current state of some game. Implement
	/// this class to provide a <see cref="TurnEngine"/> with domain specific knowledge.
